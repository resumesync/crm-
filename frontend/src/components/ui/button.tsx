  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        whatsapp: "bg-whatsapp text-whatsapp-foreground hover:bg-whatsapp/90 shadow-soft hover:shadow-medium active:scale-[0.98]",
        success: "bg-status-converted text-primary-foreground hover:bg-status-converted/90 shadow-soft active:scale-[0.98]",
        glass: "bg-card/60 backdrop-blur-lg border border-border/50 hover:bg-card/80 text-foreground shadow-soft",
      },
      size: {
